...
public class SpeechToGestureActivity extends AppCompatActivity {
    ...
    private void init() {
        ...
        speechButton.setOnClickListener(v -> {
            speechButtonOnClickListener();
        });
        backButton.setOnClickListener(v -> {
            backButtonOnClickListener();
        });
        pasteButton.setOnClickListener(v -> {
            pasteButtonOnClickListener();
        });
        clearButton.setOnClickListener(v -> {
            clearButtonOnClickListener();
        });
        plusDelayButton.setOnClickListener(v -> {
            plusDelayButtonOnClickListener();
        });
        minusDelayButton.setOnClickListener(v -> {
            minusDelayButtonOnClickListener();
        });
        showGesture.setOnClickListener(v -> {
            showGestureOnClickListener();
        });
