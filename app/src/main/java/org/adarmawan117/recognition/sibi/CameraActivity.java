...
public abstract class CameraActivity
        extends AppCompatActivity                 // onCreate, onStart, onResume, onPause, onStop, onDestroy, onRequestPermissionsResult
        implements OnImageAvailableListener,      // onImageAvailable()
        Camera.PreviewCallback,                   // onPreviewFrame()
        CompoundButton.OnCheckedChangeListener,   // apiSwitchCompat.setOnCheckedChangeListener(this);
        View.OnClickListener {                    // setup all attribut's onClickListener()
    ...
    protected void onCreate(final Bundle savedInstanceState) {
        ...
        if (!OpenCVLoader.initDebug())
            LOGGER.e("OpenCv", "Unable to load OpenCV");
        else
            LOGGER.d("OpenCv", "OpenCV loaded");
        ...
        if (useCamera2API) {
            CameraConnectionFragment camera2Fragment =
                    CameraConnectionFragment.newInstance(
                            ...
                            this,
                            getLayoutId(),                 // R.layout.camera_connection_fragment_tracking;
