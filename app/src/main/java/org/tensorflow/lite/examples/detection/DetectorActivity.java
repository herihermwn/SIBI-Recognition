...
public class DetectorActivity extends CameraActivity implements OnImageAvailableListener {
    ...
    private static final String TF_OD_API_MODEL_FILE = "palm_detection_without_custom_op.tflite";
    private static final String TF_OD_API_LABELS_FILE = "palm_detection_labelmap.txt";
